...
const Video = () => (
    <ScrollView>
        <View style={styles.container}>
            ...
            <View style={styles.imgContainer}>
                <TwicVideo src="video/turtle-swimming.mp4" focus="100px0p"/>
                <Text>Mode = cover - Ratio = 1 (default) - Focus = 100px0p</Text>
            </View>
            <View style={styles.imgContainer}>
                <TwicVideo src="video/turtle-swimming.mp4" anchor="left" />
            ...
            <View style={styles.imgContainer}>
                <TwicVideo src="video/sea-anemone.mp4" focus="0px0p" />
                <Text>Mode = cover - focus = 0px0p </Text>
            </View>
            <View style={styles.imgContainer}>
                <TwicVideo src="video/sea-anemone.mp4" style={styles.customImage} />
